<template>
  <footer class="footer">
    <div class="columns is-multiline is-mobile is-centered">
      ...
      <nav class="level">
        <div class="linking">
          <a class="bottoma" href='https://goo.gl/maps/ZtXiVzgp1t12' target='blank'>
        ...
        <div class="linking">
          <a class="bottoma" href="tel:310620707292">
            <div class="level-left">
              <div class="level-item">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" viewBox="0 0 20 20">
        ...
        <div class="linking">
          <a class='bottoma' href="mailto:hello@askcreative.space">
            <div class="level-left">
              <div class="level-item">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" viewBox="0 0 20 20">
        ...
        <div class="linking">
          <a class='bottoma' href='https://www.kvk.nl/orderstraat/bedrijf-kiezen/?q=#!shop?&q=' target='blank'>
            <div class="level-left">
              <div class="level-item">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" viewBox="0 0 20 20">
        ...
        <div class="linking">
          <a class='bottoma' href='http://ec.europa.eu/taxation_customs/vies/vatRequest.html' target='blank'>
            <div class="level-left">
              <div class="level-item">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" viewBox="0 0 20 20">
        ...
        <div class="linking">
          <router-link exact to="/info/" class='bottoma'>
            <div class="level-left">
              <div class="level-item">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40" height="40" viewBox="0 0 20 20">
...
.footer,
.panel-heading {
  background: linear-gradient(20deg, #413e3c 70%, #fefcfb);
  color: #bab2b5;
  text-align: center;
}
.logo {
...
.low {
  ...
  border: 0;
  height: 10px;
  background: linear-gradient(90deg, #ac3b61, #336ca4, #0d4276, #6c0729);
}
a {
  display: flex;
